          ...
          <>
            ...
            <div className="glass-panel fixed inset-x-0 bottom-0 z-30 mx-auto w-full max-w-md px-5 pb-5 pt-3 md:max-w-2xl">
              <button
                type="button"
                onClick={submit}
                className="ripple flex w-full items-center justify-center gap-2 rounded-2xl bg-primary px-4 py-3.5 text-sm font-black tracking-tight text-primary-foreground transition-all duration-300 active:scale-[0.98]"
              >
